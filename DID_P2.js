...
function preload() {
  // Load the CSV file
  table = loadTable('cleaned_sleep_Laura.csv', 'csv', 'header');
}
...
function setup() {
  ...
  days = [
    ...
    { start: new Date('2024-11-01T20:00:00'), end: new Date('2024-11-02T11:00:00'), day: 4 }, //Laura har ikke anvendt det mellem 02-03 November
    ...
    { start: new Date('2024-11-05T20:00:00'), end: new Date('2024-11-06T11:00:00'), day: 7 },
    { start: new Date('2024-12-02T20:00:00'), end: new Date('2024-12-03T11:00:00'), day: 8 },
    { start: new Date('2024-12-03T20:00:00'), end: new Date('2024-12-04T11:00:00'), day: 9 },
  ];
